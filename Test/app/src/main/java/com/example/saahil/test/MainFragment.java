...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ImageView im = (ImageView) rootView.findViewById(R.id.im1) ;
        final ProgressBar p = (ProgressBar) rootView.findViewById(R.id.pb1);
        ...
        //if(mWebView.getUrl() == null) {
            mWebView.setWebViewClient(new WebViewClient(){
                ...
                public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                    Toast toast = Toast.makeText(getActivity(), "Error : No Internet Connection \n Check your connection and \n\tTry again", Toast.LENGTH_LONG);
            ...
            mWebView.loadUrl("http://www.abodemart.in");
       // }
